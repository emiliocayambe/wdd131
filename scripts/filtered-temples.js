/* Display current last modified date in the footer */
document.getElementById("lastModified").innerHTML = document.lastModified;

/* Update the current year in the footer using the Date object */
...
/* Toggle hamburger menu and navigation visibility on click */
...
/* Initialize the page with all temple cards */
createTempleCards(temples);

/* --- Rendering Function --- */
function createTempleCards(filteredTemples) {
    const container = document.querySelector(".temple-cards");
    /* Clear the container before rendering filtered results */
    container.innerHTML = ""; 
...
navLinks.forEach(link => {
    link.addEventListener("click", (e) => {
        ...
        /* Filter logic based on the menu selection */
        switch (filter) {
            case "Old":
        ...
        /* Update the main heading to reflect current filter */
        document.querySelector("main h2").textContent = filter;
        
        /* Close the mobile menu after selection for better UX */
